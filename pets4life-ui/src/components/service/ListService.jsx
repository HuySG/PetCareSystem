    ...
    const filteredServices = serviceList
        .filter((service) => {
            return (
                ...
                service.serviceName.toString().toLowerCase().includes(searchTerm.toLowerCase()) ||
                service.image.toString().toLowerCase().includes(searchTerm.toLowerCase()) ||
                ...
                service.createdDate.toString().toLowerCase().includes(searchTerm.toLowerCase()) ||
                service.updatedDate.toString().toLowerCase().includes(searchTerm.toLowerCase())
                ...
                <div id="content-wrapper" className="d-flex flex-column" style={{ backgroundImage: `url(/banner.jpg)`, backgroundSize: 'cover', height: '100vh' }}>
                    ...
                    <div id="content">
                        ...
                        <div className="container-fluid">
                            {/* Page Heading */}
                            <h1 className="h3 mb-2" style={{ fontWeight: "revert", color: "#000", fontSize: "20px" }}>Services</h1>
                                ...
                                <div className="card-body">
                                    <div className="table-responsive">
                                        <table className="table table-hover" id="" width="100%" cellSpacing="0">
                                            ...
                                            <tbody>
                                                {currentServices.map((cus) => (
                                                    <tr key={cus.serviceId}>
                                                        <td>
                                                            <img src={cus.image} alt={cus.serviceName} width="100" height="100" />
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div className="btn-group" role="group">
                                                                <Link to={`/edit_service/${cus.serviceId}`}>
