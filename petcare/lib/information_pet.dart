...
import 'package:petcare/informationpet_2.dart';
import 'package:petcare/pets.dart';
import 'package:petcare/userprofile.dart';
import 'package:uuid/uuid.dart';

class informationpets extends StatefulWidget {
  const informationpets({super.key});

  @override
  State<informationpets> createState() => _informationpetsState();
}
  ...
  Future<void> _createPet() async {
    ...
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => informationpets2(
