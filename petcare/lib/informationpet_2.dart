...
class informationpets2 extends StatefulWidget {
  ...
  @override
  State<informationpets2> createState() => _informationpets2State();
}

class _informationpets2State extends State<informationpets2>
                  ...
                  GestureDetector(
                    onTap: () {
                      setState(() {
                        ...
                        isMixSelected = false;
                        _currentDietController.text =
                            'Wet Food'; // Set the controller's text
                      });
                    },
                    child: Container(
                  ...
                  GestureDetector(
                    onTap: () {
                      setState(() {
                        ...
                        isMixSelected = false;
                        _currentDietController.text =
                            'Dry Food'; // Set the controller's text
                      });
                    },
                    child: Container(
                      width: MediaQuery.of(context).size.width * 0.25,
